...
// router.get('/instructors-courses', asyncHandler(InstructorCourseController.getAllInstructorCourses));// not uses
router.get('/instructors-departments-courses', asyncHandler(InstructorCourseController.getInstructorsDepartmentsCourses));
// router.post('/instructors-courses', asyncHandler(InstructorCourseController.addInstructorCourses)); // not uses
